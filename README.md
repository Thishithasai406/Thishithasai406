...
<img src="https://user-images.githubusercontent.com/1303154/88677602-1635e900-d120-11ea-84d8-d263ba5fc3c0.gif" width="30px" alt="wave">

# Hey there! I'm Bellamkonda Thishitha Sai 👋

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=4000&pause=1000&color=00D9FF&center=true&vCenter=true&width=900&lines=Cloud+%2C+AIML+%26+Full+Stack+Developer;Building+Real-Time+%26+Scalable+Applications;AWS+Certified+Cloud+Practitioner)](https://github.com/Thishithasai406)
...
I am a **B.Tech Computer Science Engineering (AIML)** student at **SRM University AP**, with a strong passion for building intelligent, scalable, and real-world applications. My interests lie at the intersection of **Full Stack Development, Cloud Computing, and Artificial Intelligence**, where I focus on creating systems that are both smart and production-ready.

- 💻 **Full Stack Developer** experienced in building responsive, scalable, and real-time web applications
...
### 🛡️ DisasterShield — Real-Time Emergency Response SaaS Platform

Full-stack disaster response platform with real-time workflows, geospatial mapping, and RBAC dashboards for citizens, volunteers & admins.
...
### ☁️ AWS Data Confluence — Real-Time Serverless Analytics Platform

Fully serverless event ingestion pipeline on AWS — React → API Gateway → Lambda → S3 data lake with automated schema discovery and SQL analytics.
...
### 🤟 SignSpeak — Real-Time American Sign Language Recognition System

CNN-based deep learning model recognizing 26 ASL alphabets in real-time with MediaPipe, OpenCV, text-to-speech & spell-checking for hearing-impaired accessibility.
...
<img src="https://streak-stats.demolab.com?user=Thishithasai406&theme=tokyonight&hide_border=true&date_format=M%20j%5B%2C%20Y%5D&ring=00D9FF&fire=00D9FF&currStreakLabel=00D9FF" width="70%" />
